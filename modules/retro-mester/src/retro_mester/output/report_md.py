"""T026 — Deterministic Markdown report builder for retro-mester US1.
...
def build_report_md(
    ...
    *,
    ...
    """Build the US1 Markdown retrospective report.

    Generates a deterministic Markdown string covering section (A) —
    covered recommendations ranked 1..N in a table, followed by a
    summary line for uncovered gaps.  When ``llm_block`` is supplied
    (US2+) it is appended verbatim as section (B).
