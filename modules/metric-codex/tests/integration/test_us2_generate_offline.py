...
class TestDryRunOfflineNoPii:
    ...
    def test_staging_dir_created(self, ingested_data_root, question_set_path):
        ...
        staging = ingested_data_root / "silver" / "metric-codex" / _KEY / "staging"
    ...
    def test_no_10digit_student_id_in_any_staging_file(self, ingested_data_root, question_set_path):
    ...
    def test_no_korean_name_in_any_staging_file(self, ingested_data_root, question_set_path):
    ...
    def test_staging_json_is_valid_and_has_pseudonym(self, ingested_data_root, question_set_path):
    ...
    def test_staging_deterministic_second_run(self, ingested_data_root, question_set_path):
...
class TestGenerateBackendNone:
    ...
    def test_one_md_per_student(self, ingested_data_root, question_set_path):
        ...
        student_dir = ingested_data_root / "gold" / "metric-codex" / _KEY / "학생별"
    ...
    def test_manifest_records_template_backend(self, ingested_data_root, question_set_path):
        _run_generate_offline(ingested_data_root, question_set_path)
        manifest_path = (
            ingested_data_root / "silver" / "metric-codex" / _KEY / "manifest_metric-codex.json"
        )
...
class TestGenerateApiFallback:
    ...
    def test_api_unreachable_falls_back_to_template(
        ...
        monkeypatch.setattr("metric_codex.generate.backend.ApiBackend.generate", _broken_generate)
